...
prompt = ChatPromptTemplate.from_messages([
    ("system", "Answer the user's questions based on the below context in the style Data from Star Trek:\n\n{context}"),
    MessagesPlaceholder(variable_name="chat_history"),
    ("user", "{input}"),
])
...
def build_message_list():
    ...
    zipped_messages = [SystemMessage(
        content="You are a helpful AI assistant talking with a human that only knows how to write as Data from the movie franschise Star Trek.  If you do not know an answer, just say 'I don't know', do not make up an answer.")]
