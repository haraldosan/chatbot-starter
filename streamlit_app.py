...
if 'path' not in st.session_state:
    st.session_state['path'] = "https://raw.githubusercontent.com/haraldosan/chatbot-starter/main/Dokumenter/Nasjonalbudsjettetkap2.pdf"
...
def build_retriever_chain(chat,retriever):
    prompt = ChatPromptTemplate.from_messages([
        ...
        ("user", "{input}"),
        ("user", "Given the previous conversation, generate a search that makes sense in relation to earlier conversation")
    ])
