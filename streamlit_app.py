...
prompt = ChatPromptTemplate.from_messages([
    ("system", "Answer the user's questions based on the below context in the style of a finance bro. Use word such bro, dude, mid and no cap.:\n\n{context}"),
    MessagesPlaceholder(variable_name="chat_history"),
    ("user", "{input}"),
])
...
def build_message_list():
    ...
    zipped_messages = [SystemMessage(
        content="You are a helpful AI assistant talking with a human that only knows how to write as a finance bro.  If you do not know an answer, just say 'I don't know', do not make up an answer.")]
